...
@section('content')
    <div class="card">
        ...
        @if ($errors->any())
            <div class="alert-message"
                style="background: #fee2e2; border: 1px solid #ef4444; color: #b91c1c; padding: 1rem; border-radius: 0.5rem; margin-bottom: 2rem;">
        ...
        <div
            ...
            <div style="flex: 1;">
                <label
                    style="display: block; font-size: 0.75rem; font-weight: 700; color: #64748b; text-transform: uppercase; margin-bottom: 0.5rem;">Filter
                    by Product</label>
            ...
            <button onclick="resetFilters()" class="btn"
                style="background: #64748b; color: white; padding: 0.65rem 1.5rem; border-radius: 0.5rem; font-weight: 700; height: 42px;">
        ...
        <div
            ...
            <div
                ...
                <button type="button" onclick="closeAddModal()"
                    style="background: none; border: none; font-size: 1.25rem; color: #64748b; cursor: pointer;">
            ...
            <form action="{{ route('admin.clients.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    ...
                    <div class="form-group">
                        ...
                        <select name="state" id="add_state" class="form-control" required>
                    ...
                    <div class="form-group" style="grid-column: span 2;">
                        ...
                        <input type="text" name="address" class="form-control" required
                            placeholder="House/Office No., Street, City...">
                    </div>

                    <!-- Contact Person 1 -->
                    <div class="section-divider"
                        style="grid-column: span 2; margin-top: 1rem; border-top: 1px dashed #e2e8f0; padding-top: 1rem;">
                        <span
                            style="font-size: 0.85rem; font-weight: 700; color: #64748b; text-transform: uppercase;">Primary
                            Contact Person</span>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Name <span style="color: red;">*</span></label>
                        <input type="text" name="contact_person1_name" class="form-control"
                            placeholder="Primary Contact Name" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Phone <span style="color: red;">*</span></label>
                        <input type="text" name="contact_person1_phone" class="form-control"
                            placeholder="Primary Contact Phone" required>
                    </div>

                    <!-- Contact Person 2 -->
                    <div class="section-divider"
                        style="grid-column: span 2; margin-top: 0.5rem; border-top: 1px dashed #e2e8f0; padding-top: 1rem;">
                        <span
                            style="font-size: 0.85rem; font-weight: 700; color: #64748b; text-transform: uppercase;">Secondary
                            Contact Person</span>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Name</label>
                        <input type="text" name="contact_person2_name" class="form-control"
                            placeholder="Secondary Contact Name">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Phone</label>
                        <input type="text" name="contact_person2_phone" class="form-control"
                            placeholder="Secondary Contact Phone">
                    </div>

                    <!-- Business Type Toggles -->
                    <div class="form-group"
                        style="grid-column: span 2; margin-top: 1.5rem; margin-bottom: 1.5rem; background: #f8fafc; padding: 1.5rem; border-radius: 0.75rem; border: 1px solid #e2e8f0;">
                        <label class="form-label"
                            style="text-align: center; display: block; margin-bottom: 1rem; font-weight: 800; text-transform: uppercase; letter-spacing: 0.05em;">Business
                            Type</label>
                        <div style="display: flex; justify-content: center; gap: 1rem; flex-wrap: wrap;">
                            <input type="radio" name="business_type" id="add_type_product" value="product" checked
                                onchange="toggleClientFields('add')" style="display: none;">
                            <label for="add_type_product" class="biz-toggle">Product</label>

                            <input type="radio" name="business_type" id="add_type_project" value="project"
                                onchange="toggleClientFields('add')" style="display: none;">
                            <label for="add_type_project" class="biz-toggle">Project</label>

                            <input type="radio" name="business_type" id="add_type_service" value="service"
                                onchange="toggleClientFields('add')" style="display: none;">
                            <label for="add_type_service" class="biz-toggle">Service</label>

                            <input type="radio" name="business_type" id="add_type_both" value="both"
                                onchange="toggleClientFields('add')" style="display: none;">
        ...
        <div
            ...
            <form id="editClientForm" method="POST" enctype="multipart/form-data">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    ...
                    <div class="form-group">
                        <label class="form-label">Name <span style="color: red;">*</span></label>
                        <input type="text" name="contact_person1_name" id="edit_contact_person1_name"
                            class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Phone <span style="color: red;">*</span></label>
                        <input type="text" name="contact_person1_phone" id="edit_contact_person1_phone"
                            class="form-control" required>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="form-label">Name</label>
                        <input type="text" name="contact_person2_name" id="edit_contact_person2_name"
                            class="form-control">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Phone</label>
                        <input type="text" name="contact_person2_phone" id="edit_contact_person2_phone"
                            class="form-control">
                    </div>
                    ...
                    <div class="form-group"
                        ...
                        <label class="form-label"
                            ...
                            Type</label>
                        <div style="display: flex; justify-content: center; gap: 1rem; flex-wrap: wrap;">
                            <input type="radio" name="business_type" id="edit_type_product" value="product"
                                onchange="toggleClientFields('edit')" style="display: none;">
                            <label for="edit_type_product" class="biz-toggle">Product</label>

                            <input type="radio" name="business_type" id="edit_type_project" value="project"
                                onchange="toggleClientFields('edit')" style="display: none;">
                            <label for="edit_type_project" class="biz-toggle">Project</label>

                            <input type="radio" name="business_type" id="edit_type_service" value="service"
                                onchange="toggleClientFields('edit')" style="display: none;">
                            <label for="edit_type_service" class="biz-toggle">Service</label>

                            <input type="radio" name="business_type" id="edit_type_both" value="both"
                                onchange="toggleClientFields('edit')" style="display: none;">
                    ...
                    <div id="edit_product_section" class="form-group" style="grid-column: span 2;">
                        <label class="form-label">Product Name (Multiple)</label>
                        <select name="product_id[]" id="edit_product_name_select2" class="form-control select2-modal"
                            multiple>
                            @foreach ($products as $product)
                                <option value="{{ $product->id }}">{{ $product->name }}</option>
                            @endforeach
                    ...
                    <div id="edit_project_section" class="form-group" style="grid-column: span 2; display: none;">
                        <label class="form-label">Project Name (Multiple)</label>
                        <select name="project_id[]" id="edit_project_id_select2" class="form-control select2-modal"
                            multiple>
                            @foreach ($projects as $project)
                                <option value="{{ $project->id }}">{{ $project->name }}</option>
                            @endforeach
                    ...
                    <div class="form-group">
                        <label class="form-label">Attachment</label>
                        <input type="file" name="attachment" class="form-control">
                        <div id="edit_attachment_preview" style="margin-top: 0.5rem; font-size: 0.8rem; color: #64748b;">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Status</label>
    ...
    <div id="viewClientModal"
        ...
        <div
            ...
            <!-- Header -->
            <div
                style="padding: 1.5rem 2rem; background: #fff; border-bottom: 1px solid #f1f5f9; display: flex; justify-content: space-between; align-items: start;">
                <div>
                    <h2 style="margin: 0; font-size: 1.5rem; font-weight: 800; color: #0f172a;" id="view_name">Client Name
                    </h2>
                ...
                <button onclick="closeViewModal()"
                    style="background: #f8fafc; border: none; width: 32px; height: 32px; border-radius: 50%; color: #64748b; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: background 0.2s;">
                    <i class="fas fa-times"></i>
                </button>
            </div>
            ...
            <div style="padding: 2rem;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 2rem;">
                    ...
                    <div style="display: flex; gap: 0.75rem;">
                        <div
                            style="width: 36px; height: 36px; background: #eff6ff; color: #3b82f6; border-radius: 8px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                            <i class="fas fa-envelope"></i>
                        </div>
                        <div>
                            <div
                                style="font-size: 0.7rem; font-weight: 700; color: #94a3b8; text-transform: uppercase; margin-bottom: 2px;">
                                Email</div>
                    ...
                    <div style="display: flex; gap: 0.75rem;">
                        <div
                            style="width: 36px; height: 36px; background: #f0fdf4; color: #22c55e; border-radius: 8px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                    ...
                    <div style="display: flex; gap: 0.75rem; grid-column: span 2;">
                        <div
                            style="width: 36px; height: 36px; background: #f5f3ff; color: #8b5cf6; border-radius: 8px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                        ...
                        <div style="flex-grow: 1;">
                            ...
                            <div style="display: flex; gap: 1.5rem;">
                                <div>
                                    ...
                                    <div id="view_country" style="font-size: 0.95rem; font-weight: 600; color: #334155;">
                                    </div>
                                </div>
                                <div>
                                    <div style="font-size: 0.65rem; color: #94a3b8;">State</div>
                                    <div id="view_state" style="font-size: 0.95rem; font-weight: 600; color: #334155;">
                                    </div>
                                </div>
                            </div>
                ...
                <div style="margin-bottom: 2rem;">
                    <h4
                        style="margin: 0 0 1rem 0; font-size: 0.75rem; font-weight: 800; color: #64748b; text-transform: uppercase; letter-spacing: 0.05em;">
                        Point of Contacts</h4>
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                        <!-- Primary -->
                        <div
                            style="border: 1px solid #e2e8f0; border-radius: 0.75rem; padding: 1rem; background: #f8fafc;">
                            <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem;">
                                <span style="width: 8px; height: 8px; background: #3b82f6; border-radius: 50%;"></span>
                                <span
                                    style="font-size: 0.7rem; font-weight: 700; color: #0f172a; text-transform: uppercase;">Primary</span>
                            </div>
                        ...
                        <div style="border: 1px solid #e2e8f0; border-radius: 0.75rem; padding: 1rem; background: #fff;">
                            <div style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0.5rem;">
                                ...
                                <span
                                    style="font-size: 0.7rem; font-weight: 700; color: #64748b; text-transform: uppercase;">Secondary</span>
                            </div>
                ...
                <div style="background: #fff; border-radius: 0.5rem; margin-bottom: 1.5rem;">
                    <h4
                        style="margin: 0 0 0.5rem 0; font-size: 0.75rem; font-weight: 800; color: #64748b; text-transform: uppercase;">
                        Remarks</h4>
...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#add_project_id').select2({
                ...select2Options,
                placeholder: "Select Projects"
            });
            $('#add_service_id').select2({
                ...select2Options,
            ...
            $('#edit_product_name_select2').select2({
                ...select2Options,
                placeholder: "Select Products"
            });
            $('#edit_project_id_select2').select2({
                ...select2Options,
                placeholder: "Select Projects"
            });
            $('#edit_service_id_select2').select2({
                ...select2Options,
                placeholder: "Select Services"
            });
        ...
        function loadCountries() {
            fetch('https://countriesnow.space/api/v0.1/countries')
                ...
                .then(data => {
                    if (data.data) {
                        countriesList = data.data.map(c => c.country).sort();
                        const addCountry = document.getElementById('add_country');
                        const editCountry = document.getElementById('edit_country');
                        
                        countriesList.forEach(country => {
                            addCountry.appendChild(new Option(country, country));
                            editCountry.appendChild(new Option(country, country));
                        });
                    }
                })
        ...
        $('#add_country').on('change', function() {
            loadStates('add', this.value);
        });

        $('#edit_country').on('change', function() {
            loadStates('edit', this.value);
        });

        function loadStates(type, countryName, selectedState = null) {
            const stateSelect = $(`#${type}_state`);
            stateSelect.empty().append('<option value="">Loading...</option>').trigger('change');
            ...
            .catch(err => {
                ...
                stateSelect.empty().append('<option value="">Error loading states</option>').trigger('change');
                stateSelect.prop('disabled', false);
            });
        }
        ...
        function toggleClientFields(type) {
            ...
            if (type === 'add') {
                ...
                document.getElementById('add_product_section').style.display = (value === 'product' || value === 'both') ?
                    'block' : 'none';
                document.getElementById('add_project_section').style.display = (value === 'project' || value === 'both') ?
                    'block' : 'none';
                document.getElementById('add_service_section').style.display = (value === 'service' || value === 'both') ?
                    'block' : 'none';
                ...
                value = checkedRadio ? checkedRadio.value : 'product';
                document.getElementById('edit_product_section').style.display = (value === 'product' || value === 'both') ?
                    'block' : 'none';
                document.getElementById('edit_project_section').style.display = (value === 'project' || value === 'both') ?
                    'block' : 'none';
                document.getElementById('edit_service_section').style.display = (value === 'service' || value === 'both') ?
                    'block' : 'none';
            }
        }
        ...
        function addServiceRow(type, data = null) {
            ...
            row.style =
                'display: grid; grid-template-columns: 2fr 1fr 1fr 40px; gap: 0.5rem; margin-bottom: 0.75rem; align-items: end; background: #fff; padding: 0.75rem; border-radius: 0.5rem; border: 1px solid #e2e8f0;';
        ...
        function editClient(id) {
            fetch(`{{ url('admin/clients') }}/${id}/edit`)
                ...
                .then(data => {
                    ...
                    if (data.country) {
                        loadStates('edit', data.country, data.state);
                    } else {
                        $('#edit_state').empty().append('<option value="">Select State</option>').trigger('change');
                    }
                    ...
                    const radio = document.querySelector(
                        `#editClientModal input[name="business_type"][value="${bizType}"]`);
            ...
            fetch(`{{ url('admin/clients') }}/${id}/edit`)
                ...
                .then(data => {
                    ...
                    if (data.product_id && Array.isArray(data.product_id) && data.product_id.length > 0) {
                        ...
                        productHtml = clientProducts.map(p =>
                            `<span style="display:inline-block; background: #eff6ff; color: #1d4ed8; padding: 0.25rem 0.75rem; border-radius: 999px; font-size: 0.75rem; font-weight: 600; margin-right: 0.5rem; margin-bottom: 0.5rem;">${p.name}</span>`
                            ).join('');
                    }
                    ...
                    if (data.project_id && Array.isArray(data.project_id) && data.project_id.length > 0) {
                        ...
                        projectHtml = clientProjects.map(p => {
                            ...
                            if (endDateObj) {
                                ...
                                if (diffDays < 0) {
                                    remainingDaysHtml =
                                        `<span style="display:inline-block; background: #fee2e2; color: #dc2626; padding: 2px 8px; border-radius: 4px; font-size: 0.7rem; font-weight: 700; border: 1px solid #fecaca; margin-top: 4px;">EXPIRED (${Math.abs(diffDays)} days ago)</span>`;
                                } else if (diffDays === 0) {
                                    remainingDaysHtml =
                                        `<span style="display:inline-block; background: #fff7ed; color: #ea580c; padding: 2px 8px; border-radius: 4px; font-size: 0.7rem; font-weight: 700; border: 1px solid #ffedd5; margin-top: 4px;">EXPIRES TODAY</span>`;
                                } else {
                                    remainingDaysHtml =
                                        `<span style="font-size: 0.7rem; color: #64748b; margin-top: 4px; display: block;">${diffDays} days remaining</span>`;
                                }
                            }
                    ...
                    if (data.services && data.services.length > 0) {
                        ...
                        serviceHtml = data.services.map(cs => {
                            ...
                            const startDate = cs.start_date ? new Date(cs.start_date).toLocaleDateString(
                                'en-GB') : 'N/A';
