    ...
    <div style="background: white; width: 500px; margin: 5% auto; padding: 2rem; border-radius: 0.5rem;">
        ...
        <form action="{{ route('admin.products.store') }}" method="POST">
            ...
            <div style="display: flex; gap: 1rem; margin-top: 1.5rem;">
                ...
                <button type="button" onclick="document.getElementById('addProductModal').style.display='none'" class="btn" style="flex:1; background: #e5e7eb;">Cancel</button>
            </div>
        </form>
    </div>
</div>
    ...
    <div style="background: white; width: 500px; margin: 5% auto; padding: 2rem; border-radius: 0.5rem;">
        ...
        <form id="editProductForm" method="POST">
            ...
            <div style="display: flex; gap: 1rem; margin-top: 1.5rem;">
                ...
                <button type="button" onclick="document.getElementById('editProductModal').style.display='none'" class="btn" style="flex:1; background: #e5e7eb;">Cancel</button>
            </div>
        </form>
    </div>
</div>
