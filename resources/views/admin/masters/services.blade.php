        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if($service->category)
                            <span class="badge" style="background: #e0e7ff; color: #4338ca; font-weight: 600;">{{ $service->category->name }}</span>
                        @else
                    ...
                    <td>
                        @if($service->subcategory)
                            <span class="badge" style="background: #dbeafe; color: #1e40af; font-weight: 600;">{{ $service->subcategory->name }}</span>
                        @else
                            <span style="color: #9ca3af; font-style: italic;">-</span>
                        @endif
                    </td>
                    ...
                    <td>
                        <div style="display: flex; gap: 0.5rem;">
                            ...
                            <button onclick="editService({{ $service->id }})" class="btn btn-primary" style="padding: 0.4rem 0.7rem; font-size: 0.75rem;">
