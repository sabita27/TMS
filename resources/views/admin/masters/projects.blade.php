                ...
                <tbody>
                    @foreach ($projects as $project)
                        <tr>
                            ...
                            <td>{{ $project->end_date ? \Carbon\Carbon::parse($project->end_date)->format('M d, Y') : '-' }}
                            </td>
                            <td>
        ...
        <div
            ...
            <div
                ...
                <div style="display: flex; align-items: center; gap: 1rem;">
                    <div
                        style="width: 48px; height: 48px; background: #4f46e5; color: white; border-radius: 1rem; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; box-shadow: 0 10px 15px -3px rgba(79, 70, 229, 0.3);">
                        <i class="fas fa-project-diagram"></i>
                    </div>
                    <div>
                        <h3
                            style="margin: 0; font-size: 1.25rem; font-weight: 800; color: #1e293b; letter-spacing: -0.025em;">
                            Project Information</h3>
                        <p style="margin: 0; font-size: 0.875rem; color: #64748b;">Comprehensive overview of project
                            parameters</p>
                    </div>
                </div>
                <button onclick="closeViewModal()"
                    style="background: white; border: 1px solid #e2e8f0; width: 36px; height: 36px; border-radius: 50%; color: #94a3b8; cursor: pointer; transition: all 0.2s; display: flex; align-items: center; justify-content: center; box-shadow: 0 1px 2px rgba(0,0,0,0.05);">
            ...
            <div style="padding: 2.5rem;">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem;">
                    ...
                    <div
                        style="grid-column: span 2; background: #f1f5f9; padding: 1.5rem; border-radius: 1rem; border: 1px solid #e2e8f0;">
                        <label
                            style="display: flex; align-items: center; gap: 0.5rem; color: #475569; font-weight: 700; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.1em; margin-bottom: 0.75rem;">
                            <i class="fas fa-tag"></i> Primary Project Name
                        </label>
                        <div id="view_project_name"
                            style="font-size: 1.5rem; font-weight: 800; color: #0f172a; line-height: 1.2;"></div>
                    </div>

                    <!-- Color Coded Dates -->
                    <div
                        style="background: #fff1f2; padding: 1.25rem; border-radius: 1rem; border: 1px solid #ffe4e6; display: flex; flex-direction: column; gap: 0.5rem;">
                        <label
                            style="display: flex; align-items: center; gap: 0.5rem; color: #e11d48; font-weight: 700; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.05em;">
                    ...
                    <div
                        style="background: #f0f9ff; padding: 1.25rem; border-radius: 1rem; border: 1px solid #e0f2fe; display: flex; flex-direction: column; gap: 0.5rem;">
                        <label
                            style="display: flex; align-items: center; gap: 0.5rem; color: #0284c7; font-weight: 700; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.05em;">
                    ...
                    <!-- Progress/Status Row -->
                    <div
                        style="display: flex; align-items: center; justify-content: space-between; grid-column: span 2; padding: 1rem 1.5rem; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 1rem;">
                        <div style="display: flex; align-items: center; gap: 1rem;">
                            <label
                                style="color: #64748b; font-weight: 700; font-size: 0.75rem; text-transform: uppercase;">Current
                                Status:</label>
                    ...
                    <div style="grid-column: span 2;">
                        <label
                            style="display: flex; align-items: center; gap: 0.5rem; color: #64748b; font-weight: 700; font-size: 0.75rem; text-transform: uppercase; margin-bottom: 0.75rem;">
                            <i class="fas fa-file-alt"></i> Detailed Project Description
                        </label>
                        <div id="view_project_description"
                            style="min-height: 150px; padding: 1.5rem; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 1rem; color: #334155; line-height: 1.6; font-size: 1rem; box-shadow: inset 0 2px 4px rgba(0,0,0,0.02);">
                        </div>
                    </div>

                    <!-- Internal Remarks -->
                    <div
                        style="grid-column: span 2; background: #fffbeb; padding: 1.5rem; border-radius: 1rem; border: 1px solid #fde68a;">
                        <label
                            style="display: flex; align-items: center; gap: 0.5rem; color: #b45309; font-weight: 700; font-size: 0.75rem; text-transform: uppercase; margin-bottom: 0.5rem;">
                            <i class="fas fa-comment-dots"></i> Stakeholder Remarks & Notes
                        </label>
                        <div id="view_remarks"
                            style="color: #92400e; font-size: 0.9375rem; line-height: 1.5; font-style: italic;"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <form id="editProjectForm" method="POST" enctype="multipart/form-data">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    ...
                    <div class="form-group" style="grid-column: span 2;">
                        <label class="form-label">Attachment</label>
                        <input type="file" name="attachment" class="form-control">
                        <div id="edit_attachment_preview"
                            style="margin-top: 0.5rem; font-size: 0.8rem; color: var(--text-muted);"></div>
                    </div>
                    <div class="form-group" style="grid-column: span 2;">
        ...
        function viewProject(id) {
            fetch(`{{ url('admin/projects') }}/${id}/edit`)
                ...
                .then(data => {
                    ...
                    document.getElementById('view_start_date').innerText = data.start_date ? new Date(data.start_date)
                        .toLocaleDateString('en-US', {
                            month: 'long',
                            day: 'numeric',
                            year: 'numeric'
                        }) : 'Not Specified';
                    document.getElementById('view_end_date').innerText = data.end_date ? new Date(data.end_date)
                        .toLocaleDateString('en-US', {
                            month: 'long',
                            day: 'numeric',
                            year: 'numeric'
                        }) : 'Not Specified';
                    document.getElementById('view_project_description').innerHTML = data.description ||
                        '<em style="color:#94a3b8">No description provided for this project.</em>';
